...
import 'package:cloud_music/base_framework/ui/widget/skeleton/base_skeleton/base_skeleton_widget.dart';
  ...
  Widget buildItem(){
    return getShimmer(Container(
      ...
      decoration: BoxDecoration(
        color: skeletonColor,borderRadius: BorderRadius.circular(getHeightPx(10))
      ),
