class Block7 {
  ...
  Block7({this.blockCode, this.showType, this.uiElement, this.creatives, this.canClose});

  Block7.fromJson(Map<String, dynamic> json) {
...
class UiElement {
  ...
  UiElement.fromJson(Map<String, dynamic> json) {
    ...
    subTitle = json['subTitle'] != null ? new SubTitle.fromJson(json['subTitle']) : null;
...
//    if (json['alias'] != null) {
//      alias = new List<Null>();
//      json['alias'].forEach((v) { alias.add(new Null.fromJson(v)); });
//    }
    trans = json['trans'];
