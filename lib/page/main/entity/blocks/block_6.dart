class Block6 {
  ...
  Block6.fromJson(Map<String, dynamic> json) {
...
class ResourceExtInfo {
  ...
  ResourceExtInfo(
      {this.artists, this.alias, this.songData, this.songPrivilege});
  ...
  ResourceExtInfo.fromJson(Map<String, dynamic> json) {
    ...
    songData = json['songData'] != null
        ? new SongData.fromJson(json['songData'])
        : null;
    songPrivilege = json['songPrivilege'] != null
        ? new SongPrivilege.fromJson(json['songPrivilege'])
        : null;
  }
...
//        songs.add(new dynamic.fromJson(v));
//      });
//    }
    alias = json['alias'].cast<String>();
    status = json['status'];
